...
% input.grouping = (1:size(input.brain_data,1)); % NO GROUPING
input.grouping = grouping; % AGE grouping
...
input.behav_names = strrep(Y_labels, '"', ''); 
...
% input.img_names = load_BRAIN_TW_FA.TRACT_name_clean';
%% ---------- Options for PLS ----------
